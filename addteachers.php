        ...
        if (empty($_FILES['file']['tmp_name'])) {
            ...
            while (!feof($handle)) {
                ...
                $q = mysqli_query(mysqli_connect("localhost", "root", "", "ttms"),
                    "INSERT INTO teachers VALUES ('$facno','$name','$designation','$Cabin','$contact','$email')");
                if ($q) {
            ...
            <div style="display:none" id="addTeacherForm">
                <form action="addteacherFormValidation.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="varchar" class="form-control" id="facultyno" name="TF" placeholder="Faculty No ...">
                    </div>
                    ...
                    <div class="form-group">
                        <label for="Cabin">Cabin Location</label>
                        <input type="varchar" class="form-control" id="teacheremailid" name="Cb">
                    </div>
                    <div class="form-group">
