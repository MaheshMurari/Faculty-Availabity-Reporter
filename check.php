...
<div class="wrapper">
    <div class="form">
<div style=" background:#F4D03F; width: 330px; padding-top: 60px;height: 150px;border-radius: 10px; text-align: center; font-size: 30px; font-color: white; display: inline-flex;" >
 <?php
...
if(isset($_POST['submit']))
  {
    ...
    if($period=='period1'){
    echo '<center> <td>' . $row["period1"].  "</td></tr> </center>";
    }
    else if($period=='period2'){
    echo '<center> <td> <p>'. $row["period2"].  "</p> </td></tr> </center>";
    }
    else if($period=='period3'){
    echo  '<center> <td>' . $row["period3"].  "</td></tr> </center>";
    }
    else if($period=='period4'){
    echo  '<center> <td>' . $row["period4"].  "</td></tr> </center>";
    }
    else if($period=='period5'){
    echo  '<center> <td>' . $row["period5"]. "</td></tr> </center>";
    }
    else if($period=='period6'){
    echo  '<center> <td>' . $row["period6"].  "</td></tr> </center>";
    }
    else if($period=='period7'){
      echo  '<center> <td>' . $row["period7"].  "</td></tr> </center>";
      }
...
<div>
    ...
    <table id=teacherstable style="margin-left: 80px">
        ...
        <tr>
            ...
            <th width="210">Cabin Location</th>
