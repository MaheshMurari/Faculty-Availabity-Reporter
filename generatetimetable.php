...
<form action="generatetimetable.php" method="post" STYLE="margin-top : 60px " >
    <div align="center" >
    ...
    <div id="TT" style="background-color: #FFFFFF">
        <table border="2" cellspacing="3" align="center" id="timetable">
            ...
            <tr>
                ...
                <td style="text-align:center">10:30-11:20</td>
                <td style="text-align:center">11:20-12:10</td>
                <td style="text-align:center">12:10-1:00</td>
                <td style="text-align:center">2:00-2:50</td>
                <td style="text-align:center">2:50-3:40</td>
                <td style="text-align:center">3:40-4:30</td>
            </tr>
            <tr>
                <?php
                $table = null;
